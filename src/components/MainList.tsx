...
import { addTask, renameList, togglePrimary, toggleTask } from '../redux/reducers/fullInfo-reducer';
    ...
    return (
        <div className='flex flex-col gap-5 '>
            ...
            <div className='mt-5 flex justify-center'>
                <input className='bg-transparent w-fit text-gray-200 font-medium text-3xl text-center rounded-lg focus:bg-gray-700 hover:bg-gray-700' onBlur={() => (rename())} onChange={(e) => (setTextName(e.target.value))} value={textName || ""}></input>
            </div>
