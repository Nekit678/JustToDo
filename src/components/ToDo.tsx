...
export const ToDo = (props: ToDoType) => {
    ...
    return (
        <div className='bg-zinc-700 backdrop-blur-[1.5px] bg-opacity-90  w-full rounded-lg flex items-center justify-between gap-2 transition duration-150 hover:bg-zinc-500 hover:scale-[1.01]'>

            <div className='mt-2 mb-2 ml-4'>
                <Checkbox checked={closed} onClick={() => (setClosed(!closed))} className='rounded-full'></Checkbox>
                <text className='ml-4 text-gray-200'>{props.text}</text>
            </div>
